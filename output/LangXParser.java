...
public class LangXParser extends Parser {
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'Reveal'", "'Confess'", "'Mortal'", "'Divine'", "'SmallDivine'", "'Eternal'", 
			"'Dogma'", "'NEG'", "'*'", "'/'", "'+'", "'-'", "'AND'", "'OR'", "'XOR'", 
			"'Heven'", "'Hell'", "'('", "')'"
		};
	}
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 134217826L) != 0) );
			setState(13);
			match(EOF);
			}
		}
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 3:
						...
						setState(65);
						((LogicAndContext)_localctx).op = match(T__16);
						setState(66);
						expr(11);
						}
						break;
					case 4:
						...
						setState(68);
						((LogicOrContext)_localctx).op = match(T__17);
						setState(69);
						expr(10);
						}
						break;
					case 5:
						...
						setState(71);
						((LogicXorContext)_localctx).op = match(T__18);
						setState(72);
						expr(9);
						}
						break;
