...
and_end_4:
    ...
    %425 = load i32, i32* %matrix
    %426 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @strp, i32 0, i32 0), i32 %425)
    %str92 = alloca [21 x i8]
    %427 = bitcast [21 x i8]* %str92 to i8*
    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %427, i8* align 1 getelementptr inbounds ([21 x i8], [21 x i8]* @str92, i32 0, i32 0), i64 21, i1 false)
    %428 = getelementptr inbounds [21 x i8], [21 x i8]* %str92, i32 0, i32 0
    %429 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @strps, i32 0, i32 0), i8* %428)
    %430 = getelementptr inbounds [3 x [4 x i32]], [3 x [4 x i32]]* %matrix, i32 0, i32 0, i32 0
    %431 = load i32, i32* %430
    %432 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @strp, i32 0, i32 0), i32 %431)
    %433 = getelementptr inbounds [3 x [4 x i32]], [3 x [4 x i32]]* %matrix, i32 0, i32 0, i32 1
    %434 = load i32, i32* %433
    %435 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @strp, i32 0, i32 0), i32 %434)
    %436 = getelementptr inbounds [3 x [4 x i32]], [3 x [4 x i32]]* %matrix, i32 0, i32 0, i32 2
    %437 = load i32, i32* %436
    %438 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @strp, i32 0, i32 0), i32 %437)
    %439 = getelementptr inbounds [3 x [4 x i32]], [3 x [4 x i32]]* %matrix, i32 0, i32 0, i32 3
    ...
    %442 = bitcast [21 x i8]* %str93 to i8*
    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %442, i8* align 1 getelementptr inbounds ([21 x i8], [21 x i8]* @str93, i32 0, i32 0), i64 21, i1 false)
    %443 = getelementptr inbounds [21 x i8], [21 x i8]* %str93, i32 0, i32 0
    %444 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @strps, i32 0, i32 0), i8* %443)
    %445 = getelementptr inbounds [3 x [4 x i32]], [3 x [4 x i32]]* %matrix, i32 0, i32 1, i32 0
    %446 = load i32, i32* %445
    %447 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @strp, i32 0, i32 0), i32 %446)
    %448 = getelementptr inbounds [3 x [4 x i32]], [3 x [4 x i32]]* %matrix, i32 0, i32 1, i32 1
    %449 = load i32, i32* %448
    %450 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @strp, i32 0, i32 0), i32 %449)
    %451 = getelementptr inbounds [3 x [4 x i32]], [3 x [4 x i32]]* %matrix, i32 0, i32 1, i32 2
    %452 = load i32, i32* %451
    %453 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @strp, i32 0, i32 0), i32 %452)
    %454 = getelementptr inbounds [3 x [4 x i32]], [3 x [4 x i32]]* %matrix, i32 0, i32 1, i32 3
    ...
    %457 = bitcast [24 x i8]* %str94 to i8*
    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %457, i8* align 1 getelementptr inbounds ([24 x i8], [24 x i8]* @str94, i32 0, i32 0), i64 24, i1 false)
    %458 = getelementptr inbounds [24 x i8], [24 x i8]* %str94, i32 0, i32 0
    %459 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @strps, i32 0, i32 0), i8* %458)
    %460 = getelementptr inbounds [3 x [4 x i32]], [3 x [4 x i32]]* %matrix, i32 0, i32 0, i32 2
    %461 = load i32, i32* %460
    %462 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @strp, i32 0, i32 0), i32 %461)
    %463 = getelementptr inbounds [3 x [4 x i32]], [3 x [4 x i32]]* %matrix, i32 0, i32 1, i32 2
    %464 = load i32, i32* %463
    %465 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @strp, i32 0, i32 0), i32 %464)
    %466 = getelementptr inbounds [3 x [4 x i32]], [3 x [4 x i32]]* %matrix, i32 0, i32 2, i32 2
    ...
    %469 = bitcast [45 x i8]* %str95 to i8*
    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %469, i8* align 1 getelementptr inbounds ([45 x i8], [45 x i8]* @str95, i32 0, i32 0), i64 45, i1 false)
    %470 = getelementptr inbounds [45 x i8], [45 x i8]* %str95, i32 0, i32 0
    %471 = load i32, i32* %rowIndex
    %472 = load i32, i32* %colIndex
    %473 = getelementptr inbounds [3 x [4 x i32]], [3 x [4 x i32]]* %matrix, i32 0, i32 %471, i32 %472
    %474 = load i32, i32* %473
    %str96 = alloca [17 x i8]
    %475 = getelementptr inbounds [17 x i8], [17 x i8]* %str96, i32 0, i32 0
    %476 = call i32 (i8*, i8*, ...) @sprintf(i8* %475, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @strspi, i32 0, i32 0), i32 %474)
    %str97 = alloca [61 x i8]
    %477 = getelementptr inbounds [61 x i8], [61 x i8]* %str97, i32 0, i32 0
    %478 = call i8* @strcpy(i8* %477, i8* %470)
    %479 = call i8* @strcat(i8* %477, i8* %475)
    %480 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @strps, i32 0, i32 0), i8* %477)
    %divineMatrix = alloca [2 x [2 x double]]
    store [2 x [2 x double]] zeroinitializer, [2 x [2 x double]]* %divineMatrix
    %481 = getelementptr inbounds [2 x [2 x double]], [2 x [2 x double]]* %divineMatrix, i32 0, i32 0, i32 0
    store double 1.1, double* %481
    %482 = getelementptr inbounds [2 x [2 x double]], [2 x [2 x double]]* %divineMatrix, i32 0, i32 0, i32 1
    store double 2.2, double* %482
    %483 = getelementptr inbounds [2 x [2 x double]], [2 x [2 x double]]* %divineMatrix, i32 0, i32 1, i32 0
    store double 3.3, double* %483
    %484 = getelementptr inbounds [2 x [2 x double]], [2 x [2 x double]]* %divineMatrix, i32 0, i32 1, i32 1
    store double 4.4, double* %484
    %str98 = alloca [21 x i8]
    %485 = bitcast [21 x i8]* %str98 to i8*
    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %485, i8* align 1 getelementptr inbounds ([21 x i8], [21 x i8]* @str98, i32 0, i32 0), i64 21, i1 false)
    %486 = getelementptr inbounds [21 x i8], [21 x i8]* %str98, i32 0, i32 0
    %487 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @strps, i32 0, i32 0), i8* %486)
    %488 = load double, double* %divineMatrix
    %489 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @strp_real, i32 0, i32 0), double %488)
    %str99 = alloca [21 x i8]
    %490 = bitcast [21 x i8]* %str99 to i8*
    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %490, i8* align 1 getelementptr inbounds ([21 x i8], [21 x i8]* @str99, i32 0, i32 0), i64 21, i1 false)
    %491 = getelementptr inbounds [21 x i8], [21 x i8]* %str99, i32 0, i32 0
    %492 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @strps, i32 0, i32 0), i8* %491)
    %493 = getelementptr inbounds [2 x [2 x double]], [2 x [2 x double]]* %divineMatrix, i32 0, i32 1, i32 0
    %494 = load double, double* %493
    %495 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @strp_real, i32 0, i32 0), double %494)
    %496 = getelementptr inbounds [2 x [2 x double]], [2 x [2 x double]]* %divineMatrix, i32 0, i32 1, i32 1
    %497 = load double, double* %496
    %498 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @strp_real, i32 0, i32 0), double %497)
    %str100 = alloca [24 x i8]
    %499 = bitcast [24 x i8]* %str100 to i8*
    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %499, i8* align 1 getelementptr inbounds ([24 x i8], [24 x i8]* @str100, i32 0, i32 0), i64 24, i1 false)
    %500 = getelementptr inbounds [24 x i8], [24 x i8]* %str100, i32 0, i32 0
    %501 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @strps, i32 0, i32 0), i8* %500)
    %502 = getelementptr inbounds [2 x [2 x double]], [2 x [2 x double]]* %divineMatrix, i32 0, i32 0, i32 0
    %503 = load double, double* %502
    %504 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @strp_real, i32 0, i32 0), double %503)
    %505 = getelementptr inbounds [2 x [2 x double]], [2 x [2 x double]]* %divineMatrix, i32 0, i32 1, i32 0
    %506 = load double, double* %505
    %507 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @strp_real, i32 0, i32 0), double %506)
    %smallDivineMatrix = alloca [2 x [2 x float]]
    store [2 x [2 x float]] zeroinitializer, [2 x [2 x float]]* %smallDivineMatrix
    %508 = fptrunc double 5.5 to float
    %509 = getelementptr inbounds [2 x [2 x float]], [2 x [2 x float]]* %smallDivineMatrix, i32 0, i32 0, i32 0
    store float %508, float* %509
    %510 = fptrunc double 6.6 to float
    %511 = getelementptr inbounds [2 x [2 x float]], [2 x [2 x float]]* %smallDivineMatrix, i32 0, i32 0, i32 1
    store float %510, float* %511
    %512 = fptrunc double 7.7 to float
    %513 = getelementptr inbounds [2 x [2 x float]], [2 x [2 x float]]* %smallDivineMatrix, i32 0, i32 1, i32 0
    store float %512, float* %513
    %514 = fptrunc double 8.8 to float
    %515 = getelementptr inbounds [2 x [2 x float]], [2 x [2 x float]]* %smallDivineMatrix, i32 0, i32 1, i32 1
    store float %514, float* %515
    %str101 = alloca [26 x i8]
    %516 = bitcast [26 x i8]* %str101 to i8*
    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %516, i8* align 1 getelementptr inbounds ([26 x i8], [26 x i8]* @str101, i32 0, i32 0), i64 26, i1 false)
    %517 = getelementptr inbounds [26 x i8], [26 x i8]* %str101, i32 0, i32 0
    %518 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @strps, i32 0, i32 0), i8* %517)
    %519 = load float, float* %smallDivineMatrix
    %520 = fpext float %519 to double
    %521 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @strp_real, i32 0, i32 0), double %520)
    %str102 = alloca [26 x i8]
    %522 = bitcast [26 x i8]* %str102 to i8*
    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %522, i8* align 1 getelementptr inbounds ([26 x i8], [26 x i8]* @str102, i32 0, i32 0), i64 26, i1 false)
    %523 = getelementptr inbounds [26 x i8], [26 x i8]* %str102, i32 0, i32 0
    %524 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @strps, i32 0, i32 0), i8* %523)
    %525 = getelementptr inbounds [2 x [2 x float]], [2 x [2 x float]]* %smallDivineMatrix, i32 0, i32 0, i32 0
    ...
    %529 = getelementptr inbounds [2 x [2 x float]], [2 x [2 x float]]* %smallDivineMatrix, i32 0, i32 0, i32 1
    ...
    %533 = bitcast [29 x i8]* %str103 to i8*
    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %533, i8* align 1 getelementptr inbounds ([29 x i8], [29 x i8]* @str103, i32 0, i32 0), i64 29, i1 false)
    %534 = getelementptr inbounds [29 x i8], [29 x i8]* %str103, i32 0, i32 0
    %535 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @strps, i32 0, i32 0), i8* %534)
    %536 = getelementptr inbounds [2 x [2 x float]], [2 x [2 x float]]* %smallDivineMatrix, i32 0, i32 0, i32 1
    %537 = load float, float* %536
    ...
    %540 = getelementptr inbounds [2 x [2 x float]], [2 x [2 x float]]* %smallDivineMatrix, i32 0, i32 1, i32 1
    ...
    %544 = bitcast [1 x i8]* %str104 to i8*
    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %544, i8* align 1 getelementptr inbounds ([1 x i8], [1 x i8]* @str104, i32 0, i32 0), i64 1, i1 false)
    %545 = getelementptr inbounds [1 x i8], [1 x i8]* %str104, i32 0, i32 0
    %546 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @strps, i32 0, i32 0), i8* %545)
    ret i32 0
}
